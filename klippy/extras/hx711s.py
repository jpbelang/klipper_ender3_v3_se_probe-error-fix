...
class HX711S:
    def __init__(self, config):
        ...
        self.mcu.register_serial_response(self._handle_debug_hx711s, "debug_hx711s", self.oid)
        self.mcu.register_serial_response(self._handle_result_hx711s, "result_hx711s", self.oid)
