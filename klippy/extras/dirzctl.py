...
class DirZCtl:
    def __init__(self, config):
        ...
        self.mcu.register_serial_response(self._handle_debug_dirzctl, "debug_dirzctl", self.oid)
        self.mcu.register_serial_response(self._handle_result_dirzctl, "result_dirzctl", self.oid)
